  ...
  cpo.createPlayerContainer = function() {
    ...
    if($($this.overlayContainer).length === 0) {
      var o = $('<div class="videoPlayerOverlay hide hiddenTransform" id="youtubePlayerOverlay" data-hasloaded="false"></div>'),
          // https://s3.ap-south-1.amazonaws.com/choosemybicycle/cmb-website-icons/cancel-close-icons
          cButton = $('<button id="youtubeOverlayCloser" class="defaultButton closeIcon"><img src="assets/images/x-mark-black-icon.svg" class="img-responsive center-block" alt="Close" title="close"/></button>'),
          b = $("body");
      cButton.appendTo(o);
      o.appendTo(b);
    }
